...
const uint16_t lang_no[] PROGMEM = {
    ...
    (KEY_MOD_LSHIFT << 8) | KEY_RIGHTBRACE,                // 94 ^
    (KEY_MOD_LSHIFT << 8) | KEY_SLASH,                     // 95 _
    (KEY_MOD_LSHIFT << 8) | KEY_EQUAL,                     // 96 `
    KEY_A,                                          // 97 a
    KEY_B,                                          // 98 b
    KEY_C,                                          // 99 c
    KEY_D,                                          // 100 d
    ...
    (KEY_MOD_RALT << 8) | KEY_EQUAL,                // 124 | (AltGr+´)
