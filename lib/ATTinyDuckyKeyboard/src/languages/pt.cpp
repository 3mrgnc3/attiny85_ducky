...
// Portuguese (QWERTY) keyboard layout  
// Based on USB Rubber Ducky language file
// Ref: https://github.com/hak5/usbrubberducky-payloads/blob/master/languages/pt.json

const uint16_t lang_pt[] PROGMEM = {
    KEY_SPACE,                          // " " (32)
    ...
    (KEY_MOD_LSHIFT << 8) | KEY_APOSTROPHE,    // "~" (126)
};