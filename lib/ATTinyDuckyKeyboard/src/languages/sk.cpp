...
const uint16_t lang_sk[] PROGMEM = {
    KEY_SPACE,                                      // 32 ' '
    KEY_SEMICOLON,                                  // 33 !
    (KEY_MOD_LSHIFT << 8) | KEY_SEMICOLON,                 // 34 "
    KEY_X,                                          // 35 #
    (KEY_MOD_RALT << 8) | KEY_APOSTROPHE,           // 36 $ (AltGr+ô)
    (KEY_MOD_LSHIFT << 8) | KEY_APOSTROPHE,                // 37 %
    (KEY_MOD_RALT << 8) | KEY_C,                    // 38 & (AltGr+C)
    (KEY_MOD_LSHIFT << 8) | KEY_MINUS,                     // 39 '
    (KEY_MOD_LSHIFT << 8) | KEY_LEFTBRACE,                 // 40 (
    (KEY_MOD_LSHIFT << 8) | KEY_RIGHTBRACE,                // 41 )
    KEY_RIGHTBRACE,                                 // 42 *
    KEY_1,                                          // 43 +
    KEY_COMMA,                                      // 44 ,
    KEY_SLASH,                                      // 45 -
    KEY_DOT,                                        // 46 .
    (KEY_MOD_LSHIFT << 8) | KEY_BACKSLASH,                 // 47 /
    (KEY_MOD_LSHIFT << 8) | KEY_EQUAL,                     // 48 0
    (KEY_MOD_LSHIFT << 8) | KEY_1,                         // 49 1
    (KEY_MOD_LSHIFT << 8) | KEY_2,                         // 50 2
