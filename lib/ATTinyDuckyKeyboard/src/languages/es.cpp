...
const uint16_t lang_es[] PROGMEM = {
    ...
    (KEY_MOD_RALT << 8) | KEY_GRAVE,           // "[" (91) - AltGr+`
    KEY_GRAVE,                          // "\" (92) - backslash
    (KEY_MOD_RALT << 8) | KEY_APOSTROPHE,      // "]" (93) - AltGr+'
    ...
    KEY_Y,                              // "y" (121)
    KEY_Z,                              // "z" (122)
    (KEY_MOD_RALT << 8) | KEY_GRAVE | KEY_MOD_LSHIFT,  // "{" (123) - AltGr+Shift+`
    (KEY_MOD_RALT << 8) | KEY_1,               // "|" (124) - AltGr+1
    (KEY_MOD_RALT << 8) | KEY_APOSTROPHE | KEY_MOD_LSHIFT, // "}" (125) - AltGr+Shift+'
