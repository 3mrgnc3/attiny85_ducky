...
const uint16_t lang_ro[] PROGMEM = {
    ...
    KEY_Y,                                          // 121 y
    KEY_Z,                                          // 122 z
    (KEY_MOD_RALT << 8) | (KEY_MOD_LSHIFT << 8) | KEY_LEFTBRACE,   // 123 { (AltGr+Shift+[)
    (KEY_MOD_RALT << 8) | (KEY_MOD_LSHIFT << 8) | KEY_BACKSLASH,   // 124 | (AltGr+Shift+\)
    (KEY_MOD_RALT << 8) | (KEY_MOD_LSHIFT << 8) | KEY_RIGHTBRACE,  // 125 } (AltGr+Shift+])
