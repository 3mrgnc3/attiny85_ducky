...
const uint16_t lang_br[] PROGMEM = {
    ...
    KEY_8,                                          // 56 8
    KEY_9,                                          // 57 9
    (KEY_MOD_LSHIFT << 8) | KEY_SEMICOLON,                 // 58 :
    KEY_APOSTROPHE,                                 // 59 ;
    (KEY_MOD_LSHIFT << 8) | KEY_COMMA,                     // 60 <
    KEY_EQUAL,                                      // 61 =
    (KEY_MOD_LSHIFT << 8) | KEY_DOT,                       // 62 >
    (KEY_MOD_LSHIFT << 8) | KEY_BACKSLASH,                 // 63 ?
    ...
    (KEY_MOD_LSHIFT << 8) | KEY_RIGHTBRACE,                // 93 ]
    (KEY_MOD_LSHIFT << 8) | KEY_GRAVE,                     // 94 ^
    (KEY_MOD_LSHIFT << 8) | KEY_MINUS,                     // 95 _
    (KEY_MOD_LSHIFT << 8) | KEY_APOSTROPHE,                // 96 `
    KEY_A,                                          // 97 a
    KEY_B,                                          // 98 b
    KEY_C,                                          // 99 c
    KEY_D,                                          // 100 d
    ...
    (KEY_MOD_LSHIFT << 8) | KEY_LEFTBRACE,                 // 125 }
    KEY_GRAVE                                       // 126 ~
};