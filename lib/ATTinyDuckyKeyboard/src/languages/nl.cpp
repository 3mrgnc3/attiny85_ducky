...
// Standard Dutch QWERTY layout
// Based on standard Dutch keyboard layout specifications

#include "languages.h"

const uint16_t lang_nl[] PROGMEM = {
    KEY_SPACE,                                      // 32
    (KEY_MOD_LSHIFT << 8) | KEY_1,                        // 33 !
    (KEY_MOD_LSHIFT << 8) | KEY_2,                        // 34 "
    (KEY_MOD_LSHIFT << 8) | KEY_3,                        // 35 #
    (KEY_MOD_RALT << 8) | KEY_5,                   // 36 $ (AltGr+5)
    (KEY_MOD_LSHIFT << 8) | KEY_5,                        // 37 %
    (KEY_MOD_LSHIFT << 8) | KEY_7,                        // 38 &
    KEY_APOSTROPHE,                                 // 39 '
    (KEY_MOD_LSHIFT << 8) | KEY_9,                        // 40 (
    (KEY_MOD_LSHIFT << 8) | KEY_0,                        // 41 )
    (KEY_MOD_LSHIFT << 8) | KEY_LEFTBRACE,                // 42 *
    KEY_RIGHTBRACE,                                 // 43 +
    KEY_COMMA,                                      // 44 ,
    KEY_SLASH,                                      // 45 -
    KEY_DOT,                                        // 46 .
    (KEY_MOD_LSHIFT << 8) | KEY_MINUS,                    // 47 /
    KEY_0,                                          // 48 0
    KEY_1,                                          // 49 1
    KEY_2,                                          // 50 2
    KEY_3,                                          // 51 3
    ...
    KEY_102ND,                                      // 60 <
    (KEY_MOD_LSHIFT << 8) | KEY_SLASH,                    // 61 =
    (KEY_MOD_LSHIFT << 8) | KEY_102ND,                    // 62 >
    (KEY_MOD_LSHIFT << 8) | KEY_MINUS,                    // 63 ?
    (KEY_MOD_RALT << 8) | KEY_APOSTROPHE,          // 64 @ (AltGr+')
    ...
    (KEY_MOD_RALT << 8) | KEY_6,                   // 94 ^ (AltGr+6)
    (KEY_MOD_LSHIFT << 8) | KEY_SLASH,                    // 95 _
    (KEY_MOD_RALT << 8) | KEY_GRAVE,               // 96 ` (AltGr+`)
    KEY_A,                                          // 97 a
    KEY_B,                                          // 98 b
    KEY_C,                                          // 99 c
    KEY_D,                                          // 100 d
    ...
    (KEY_MOD_RALT << 8) | KEY_102ND,               // 124 | (AltGr+<)
