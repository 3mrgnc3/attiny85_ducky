// Slovenian QWERTZ keyboard layout for ATTiny85


// Based on USB Rubber Ducky si.json mapping
// ASCII characters 32-126 mapped to USB HID keycodes

#include "languages.h"

const uint16_t lang_si[] PROGMEM = {
    KEY_SPACE,                                      // 32 ' '
    (KEY_MOD_LSHIFT << 8) | KEY_1,                         // 33 !
    (KEY_MOD_LSHIFT << 8) | KEY_2,                         // 34 "
    (KEY_MOD_LSHIFT << 8) | KEY_APOSTROPHE,                // 35 #
    ...
    (KEY_MOD_LSHIFT << 8) | KEY_Z,                         // 89 Y (Slovenian QWERTZ has Y/Z swapped)
