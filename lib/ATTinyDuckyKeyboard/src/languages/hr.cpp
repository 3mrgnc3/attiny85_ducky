// Croatian QWERTZ keyboard layout for ATTiny85


// Based on USB Rubber Ducky hr.json mapping
// ASCII characters 32-126 mapped to USB HID keycodes

#include "languages.h"

const uint16_t lang_hr[] PROGMEM = {
    KEY_SPACE,                                      // 32 ' '
    ...
    (KEY_MOD_LSHIFT << 8) | KEY_Z,                         // 89 Y (Croatian QWERTZ has Y/Z swapped)
