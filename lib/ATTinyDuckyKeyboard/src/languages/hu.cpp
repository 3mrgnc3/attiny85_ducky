// Hungarian QWERTZ keyboard layout for ATTiny85


// Based on USB Rubber Ducky hu.json mapping
// ASCII characters 32-126 mapped to USB HID keycodes

#include "languages.h"

const uint16_t lang_hu[] PROGMEM = {
    KEY_SPACE,                                      // 32 ' '
    (KEY_MOD_LSHIFT << 8) | KEY_4,                         // 33 !
    (KEY_MOD_LSHIFT << 8) | KEY_2,                         // 34 "
    KEY_X,                                          // 35 #
    (KEY_MOD_RALT << 8) | KEY_APOSTROPHE,           // 36 $ (AltGr+é)
    (KEY_MOD_LSHIFT << 8) | KEY_5,                         // 37 %
    (KEY_MOD_RALT << 8) | KEY_C,                    // 38 & (AltGr+C)
    (KEY_MOD_LSHIFT << 8) | KEY_1,                         // 39 '
    (KEY_MOD_LSHIFT << 8) | KEY_8,                         // 40 (
    (KEY_MOD_LSHIFT << 8) | KEY_9,                         // 41 )
    (KEY_MOD_RALT << 8) | KEY_SLASH,                // 42 * (AltGr+-)
    (KEY_MOD_LSHIFT << 8) | KEY_3,                         // 43 +
    KEY_COMMA,                                      // 44 ,
    KEY_SLASH,                                      // 45 -
    KEY_DOT,                                        // 46 .
    (KEY_MOD_LSHIFT << 8) | KEY_6,                         // 47 /
    KEY_GRAVE,                                      // 48 0
    KEY_1,                                          // 49 1
    KEY_2,                                          // 50 2
    KEY_3,                                          // 51 3
    ...
    (KEY_MOD_RALT << 8) | KEY_COMMA,                // 59 ; (AltGr+,)
    KEY_102ND,                                      // 60 <
    (KEY_MOD_LSHIFT << 8) | KEY_7,                         // 61 =
    (KEY_MOD_LSHIFT << 8) | KEY_102ND,                     // 62 >
    (KEY_MOD_LSHIFT << 8) | KEY_COMMA,                     // 63 ?
    ...
    (KEY_MOD_LSHIFT << 8) | KEY_Z,                         // 89 Y (Hungarian QWERTZ has Y/Z swapped)
    ...
    (KEY_MOD_RALT << 8) | KEY_7,                    // 96 ` (AltGr+7)
    KEY_A,                                          // 97 a
    KEY_B,                                          // 98 b
    KEY_C,                                          // 99 c
    KEY_D,                                          // 100 d
