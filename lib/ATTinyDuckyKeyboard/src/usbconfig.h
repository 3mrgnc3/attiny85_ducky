...
// Include custom USB device configuration
 ...
 * the implications!
 */
#define USB_CFG_DEVICE_VERSION  USB_DEVICE_VERSION_MINOR, USB_DEVICE_VERSION_MAJOR
...
#define USB_CFG_SERIAL_NUMBER   USB_SERIAL_NUMBER
#define USB_CFG_SERIAL_NUMBER_LEN USB_SERIAL_NUMBER_LEN
#endif
