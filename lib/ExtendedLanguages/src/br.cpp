// Brazilian Portuguese ABNT2 keyboard layout for ATTiny85
// Based on USB Rubber Ducky br.json mapping
// ASCII characters 32-126 mapped to USB HID keycodes

#include "extendedLanguages.h"

const uint16_t lang_br[] PROGMEM = {
    KEY_SPACE,                                      // 32 ' '
    ...
    KEY_8,                                          // 56 8
    KEY_9,                                          // 57 9
    KEY_SEMICOLON | KEY_MOD_LSHIFT,                 // 58 :
    KEY_APOSTROPHE,                                 // 59 ;
    KEY_COMMA | KEY_MOD_LSHIFT,                     // 60 <
    KEY_EQUAL,                                      // 61 =
    KEY_DOT | KEY_MOD_LSHIFT,                       // 62 >
    KEY_BACKSLASH | KEY_MOD_LSHIFT,                 // 63 ?
    ...
    KEY_LEFTBRACE,                                  // 91 [
    KEY_RIGHTBRACE,                                 // 92 \ (Brazilian layout uses ] key)
    KEY_RIGHTBRACE | KEY_MOD_LSHIFT,                // 93 ]
    KEY_GRAVE | KEY_MOD_LSHIFT,                     // 94 ^
    KEY_MINUS | KEY_MOD_LSHIFT,                     // 95 _
    KEY_APOSTROPHE | KEY_MOD_LSHIFT,                // 96 `
    KEY_A,                                          // 97 a
    KEY_B,                                          // 98 b
    KEY_C,                                          // 99 c
    KEY_D,                                          // 100 d
    ...
    KEY_Y,                                          // 121 y
    KEY_Z,                                          // 122 z
    KEY_LEFTBRACE | KEY_MOD_LSHIFT,                 // 123 {
    KEY_BACKSLASH | (KEY_MOD_RALT << 8),            // 124 | (AltGr+\)
    KEY_LEFTBRACE | KEY_MOD_LSHIFT,                 // 125 }
    KEY_GRAVE                                       // 126 ~
};
