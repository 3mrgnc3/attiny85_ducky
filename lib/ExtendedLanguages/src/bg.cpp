...
// Standard Bulgarian БДС (BDS) layout for Latin ASCII characters
// Based on standard Bulgarian keyboard layout specifications

#include "extendedLanguages.h"

const uint16_t lang_bg[] PROGMEM = {
    KEY_SPACE,                                      // 32
    ...
    KEY_BACKSLASH | KEY_MOD_LSHIFT,                // 124 |
