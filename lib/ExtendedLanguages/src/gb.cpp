// UK English QWERTY keyboard layout for ATTiny85
// Based on USB Rubber Ducky gb.json mapping
// ASCII characters 32-126 mapped to USB HID keycodes

#include "extendedLanguages.h"

const uint16_t lang_gb[] PROGMEM = {
    KEY_SPACE,                                      // 32 ' '
    KEY_1 | KEY_MOD_LSHIFT,                         // 33 !
    KEY_2 | KEY_MOD_LSHIFT,                         // 34 "
    KEY_BACKSLASH,                                  // 35 # (key left of Enter)
    ...
    KEY_APOSTROPHE | KEY_MOD_LSHIFT,                // 64 @
    ...
    KEY_LEFTBRACE,                                  // 91 [
    KEY_102ND,                                      // 92 \ (key next to left shift)
    KEY_RIGHTBRACE,                                 // 93 ]
    KEY_6 | KEY_MOD_LSHIFT,                         // 94 ^
    ...
    KEY_102ND | KEY_MOD_LSHIFT,                     // 124 |
    KEY_RIGHTBRACE | KEY_MOD_LSHIFT,                // 125 }
    KEY_BACKSLASH | KEY_MOD_LSHIFT                  // 126 ~
};
