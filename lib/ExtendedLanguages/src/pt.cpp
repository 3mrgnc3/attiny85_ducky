...
const uint16_t lang_pt[] PROGMEM = {
    ...
    KEY_8 | KEY_MOD_RALT,               // "[" (91) - AltGr+8
    KEY_GRAVE,                          // "\" (92)
    KEY_9 | KEY_MOD_RALT,               // "]" (93) - AltGr+9
    ...
    KEY_Y,                              // "y" (121)
    KEY_Z,                              // "z" (122)
    KEY_7 | KEY_MOD_RALT,               // "{" (123) - AltGr+7
    KEY_BACKSLASH | KEY_MOD_LSHIFT,     // "|" (124)
    KEY_0 | KEY_MOD_RALT,               // "}" (125) - AltGr+0
    KEY_APOSTROPHE | KEY_MOD_LSHIFT,    // "~" (126)
};
