...
const uint16_t lang_ch[] PROGMEM = {
    KEY_SPACE,                                      // 32 ' '
    KEY_RIGHTBRACE | KEY_MOD_LSHIFT,                // 33 !
    ...
    KEY_3 | KEY_MOD_LSHIFT,                         // 42 *
    KEY_1 | KEY_MOD_LSHIFT,                         // 43 +
    KEY_COMMA,                                      // 44 ,
    KEY_SLASH,                                      // 45 -
    KEY_DOT,                                        // 46 .
    ...
    KEY_Z | KEY_MOD_LSHIFT,                         // 89 Y (Swiss has Y/Z swapped)
