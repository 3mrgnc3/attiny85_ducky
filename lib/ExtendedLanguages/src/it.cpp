...
const uint16_t lang_it[] PROGMEM = {
    ...
    KEY_APOSTROPHE | KEY_MOD_RALT,      // "#" (35) - AltGr+'
    ...
    KEY_GRAVE | KEY_MOD_RALT,           // "@" (64) - AltGr+`
    ...
    KEY_LEFTBRACE | KEY_MOD_RALT,       // "[" (91) - AltGr+[
    KEY_BACKSLASH,                      // "\" (92)
    KEY_RIGHTBRACE | KEY_MOD_RALT,      // "]" (93) - AltGr+]
    ...
    KEY_Y,                              // "y" (121)
    KEY_Z,                              // "z" (122)
    KEY_LEFTBRACE | KEY_MOD_RALT | KEY_MOD_LSHIFT,  // "{" (123) - AltGr+Shift+[
    KEY_BACKSLASH | KEY_MOD_LSHIFT,     // "|" (124)
    KEY_RIGHTBRACE | KEY_MOD_RALT | KEY_MOD_LSHIFT, // "}" (125) - AltGr+Shift+]
    KEY_EQUAL | KEY_MOD_RALT,           // "~" (126) - AltGr+=
};
