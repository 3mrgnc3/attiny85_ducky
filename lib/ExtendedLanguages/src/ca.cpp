...
const uint16_t lang_ca[] PROGMEM = {
    ...
    (KEY_MOD_RALT << 8) | KEY_LEFTBRACE | KEY_MOD_LSHIFT,  // 94 ^ (AltGr+Shift+`)
    ...
    KEY_Y,                                          // 121 y
    KEY_Z,                                          // 122 z
    (KEY_MOD_RALT << 8) | KEY_APOSTROPHE | KEY_MOD_LSHIFT, // 123 { (AltGr+Shift+')
    (KEY_MOD_RALT << 8) | KEY_1,                    // 124 | (AltGr+1)
    (KEY_MOD_RALT << 8) | KEY_EQUAL | KEY_MOD_LSHIFT,      // 125 } (AltGr+Shift++)
