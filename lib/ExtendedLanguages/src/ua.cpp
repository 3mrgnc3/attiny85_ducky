...
// Standard Ukrainian ЙЦУКЕН (JCUKEN) layout for Latin ASCII characters
// Based on standard Ukrainian keyboard layout specifications

#include "extendedLanguages.h"

const uint16_t lang_ua[] PROGMEM = {
    KEY_SPACE,                                      // 32
    ...
    KEY_LEFTBRACE,                                  // 91 [
    KEY_BACKSLASH | KEY_MOD_LSHIFT,                // 92 \ (backslash)
    KEY_RIGHTBRACE,                                 // 93 ]
